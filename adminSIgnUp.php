...
if (isset($_POST["submit"])){
    ...
    $sqlInsert = "INSERT INTO `admindetails`(`username`, `password`) VALUES ('$username','$password')";
    ...
    <body>
        <div class="bgImage">
            <div class="container">
                <div id="topNavBar">
                    <ul>
                        <li class="title"><a href="adminSignUp.php">FOODHUB</a></li>
                ...
                <div class="registrationForm">
                    <div class="register">
                        <form style="max-width: 600px;" method="POST" style="margin:auto" action="">
                            ...
                            <p>Already have an account? <a href="adminLogin.php" class="signup">Login</a></p>
                        </form>
                    </div>   
                </div>
            </div>
