<?php
    ...
    echo "<td class='tRow'>" . $row['category'] . "</td>";
    echo "<td class='tRow'>" . '<img id="image" src="data:image/jpg;base64,' . base64_encode( $row['image'] ) . '" />';
    echo "<td class='tRow'>" . "<a href='editFood.php'><button id='' name='edit' type='submit'>EDIT</button></a>". "</td>";
    echo "<td class='tRow'>" . "<button id='' name='order' type='submit' >DELETE</button>". "</td>";
